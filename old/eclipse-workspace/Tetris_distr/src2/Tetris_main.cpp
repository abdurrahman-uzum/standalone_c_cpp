...
bool loadMedia()
{
	std::string path = "C:/Users/Abdurrahman/eclipse-workspace/Tetris/media/";
	...
	if ( !gameOverTexture.load( "C:/Users/Abdurrahman/eclipse-workspace/Tetris/media/gameOver.png" ) )
	{
		printf( "Failed to load gameOver.bmp.\n" );
		return false;
	}
