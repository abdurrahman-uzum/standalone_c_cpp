...
const SDL_Rect gameBoundary = { 30, 10, 440, 700 };
...
void renderBackground()
{
	...
	for ( int i=1; i < 35; i++ )
	{
		SDL_RenderDrawLine( gRenderer, 31, (10 + i*Tetromino::C_LENGTH), 468, (10 + i*Tetromino::C_LENGTH)  );
	}

	for ( int i=1; i < 22; i++ )
	{
		SDL_RenderDrawLine( gRenderer, (30 + i*Tetromino::C_LENGTH), 11, (30 + i*Tetromino::C_LENGTH), 708  );
	}
}
