...
int main()
{
    ...
    directionBeforeDecision = (int*)malloc(0*sizeof(int));
    ...
    while ( !done )
    {
        ...
        while ( readForward() && !done )
        {
            ...
            if ( numberOfChoices() > 2 && readForward() )
            {
                ...
                directionBeforeDecision = realloc(directionBeforeDecision, (decision+1) * sizeof(int));
                decisions = realloc(decisions, (decision+1) * sizeof(int));
        ...
        if ( !readForward() && numberOfChoices() > 2 )
        {
            if ( readRight() )
            {
                directionBeforeDecision = realloc(directionBeforeDecision, (++decision) * sizeof(int));
                decisions = realloc(decisions, decision * sizeof(int));
